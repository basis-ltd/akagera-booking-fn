...
export function DataTablePagination<TData>({
  ...
  return (
    <footer className="flex flex-col items-center justify-between px-2">
      <article className="flex flex-col gap-1 mb-2">
      ...
      <div className="overflow-x-auto w-full">
        <menu className="flex items-center space-x-4">
          ...
          <section className="flex gap-2 items-center justify-center text-sm font-medium">
